...
const exampleContent = `<img src="https://github.com/Nikhil12894/MyEditorApp-micro_frontend/blob/main/editor_demo.gif" style="width: 1216px; height: auto; cursor: pointer; margin: 0px auto;" draggable="true"><h1 style="text-align: center">How to create Micro Frontend Using React Vite app and vite-plugin-federation</h1><h2>Remote app</h2><p><em>Demo</em>: <a target="_blank" rel="noopener noreferrer nofollow" href="https://app-editor.learnwithnk.in/">Editor app</a></p><ol><li><p>Create a remote app from which you will host the actual component.</p></li></ol><p>Install vite-plugin-federation plugin</p><p><code>npm install -D @originjs/vite-plugin-federation</code></p><ol start="2"><li><p>Create your components. ie <code>DemoComponent</code></p></li><li><p>Add this demo component in the vite config to be exported along with other configs.</p></li></ol><p>In <code>vite.config.ts</code></p><pre><code class="language-tsx">import { defineConfig } from "vite";
...
export default App;</code></pre><ol start="10"><li><p>run <code>npm run dev</code></p></li></ol>`;
